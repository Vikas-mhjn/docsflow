#!/usr/bin/env python3
"""
Diagnose where files are and fix everything.
Run from INSIDE docsflow-demo: python diagnose_and_fix.py
"""
import os
import sys
...
if not os.path.exists("package.json"):
    print("ERROR: package.json not found here.")
    print("You must run this script from INSIDE the docsflow-demo folder.")
    print()
    print("Run these commands first:")
    print("  cd C:\\Users\\vk500\\Desktop\\Stuff\\NEXT\\docsflow-demo")
    print("  python diagnose_and_fix.py")
    sys.exit(1)

print("package.json found — correct folder confirmed")
print()

# Check what component folders exist
print("Checking components folder...")
if os.path.exists("components"):
    for root, dirs, files in os.walk("components"):
        level = root.replace("components", "").count(os.sep)
        indent = "  " * level
    ...
    print("  components/ folder does NOT exist!")

print()
print("Checking actions folder...")
if os.path.exists("actions"):
    for f in os.listdir("actions"):
        print(f"  ✓ {f}")
else:
    print("  actions/ folder does NOT exist!")

print()
print("Checking lib folder...")
if os.path.exists("lib"):
    for f in os.listdir("lib"):
        print(f"  ✓ {f}")
else:
    print("  lib/ folder does NOT exist!")

print()
print("=" * 60)
print("CREATING ALL FILES NOW")
print("=" * 60)
...
# ── lib/utils.js ───────────────────────────────────────────
write("lib/utils.js", '''export function formatDate(date) {
...
write("actions/workspace.js", '''"use server";
...
# ── actions/page.js ─────────────────────────────────────────
write("actions/page.js", '''"use server";
import prisma from "@/lib/prisma";
import { revalidatePath } from "next/cache";
...
if all_good:
    ...
    print("Some files are still missing. Check errors above.")
